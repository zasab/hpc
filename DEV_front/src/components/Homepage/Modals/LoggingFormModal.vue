            ...
            <h6 class="modal-title">
              <div class="d-flex">
                <span class="fw-bold text-primary pt-3 px-2"
                  ><h5 class="text-primary">SLURM Logging</h5></span
                >
              </div>
            </h6>
          </div>
            ...
            <div class="container">
              <div class="row text-start">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="mb-3">
                    <label for="username" class="py-2 fw-bold form-label-custom"
                      >user name</label
                    >
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="mb-3">
                    <label for="serverhost" class="py-2 fw-bold form-label-custom"
                      >Server Host</label
                    >
                    <div class="form-inputs">
                      <i class="bi bi-person"></i>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="mb-3">
                    <label for="password" class="py-2 fw-bold form-label-custom"
                      >password</label
                    >
                    <div class="form-inputs">
                      <i class="bi bi-key"></i>
